"""
HA demo — master 3 of 3.

Run this + run_master1.py + run_master2.py in three terminals. They
...
ha = ClusterHA(
    ...
    state_file="ha_state_master3.json",   # survives a restart
)
...
print("master-3 running on :7072 — Ctrl-C to stop")
print("Check role anytime:  curl http://localhost:7072/v1/ha/status")
try:
    while True:
        time.sleep(1)
except KeyboardInterrupt:
    print("\nShutting down master-3...")
    master.stop()